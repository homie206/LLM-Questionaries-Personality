...
def get_model_examing_result(client_qw):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'vanilla-result/{mbti_label_content}-vanilla-induce-mbti-qwen2.5-72b-instruct-output.txt'
        result_file_name = f'vanilla-result/{mbti_label_content}-vanilla-induce-mbti-qwen2.5-72b-instruct-result.csv'
