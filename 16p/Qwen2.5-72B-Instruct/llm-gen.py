...
def get_model_examing_result(client):
    ...
    for mbti_item in prompt_template["mbti_prompt"][4:]:
        ...
        output_file_name = f'llm-gen-result/{mbti_label_content}-gen-induce-mbti-qwen2.5-72b-instruct-output.txt'
        result_file_name = f'llm-gen-result/{mbti_label_content}-gen-induce-mbti-qwen2.5-72b-instruct-result.csv'
