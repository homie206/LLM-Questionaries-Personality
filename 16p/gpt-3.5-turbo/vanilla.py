...
def get_model_examing_result():
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'/Users/haoming/Desktop/gpt_16p/LLM-Personality-Questionnaires/16p/gpt/vanilla-result/{mbti_label_content}-vanilla-mbti-gpt3.5-turbo-output.txt'
        result_file_name = f'/Users/haoming/Desktop/gpt_16p/LLM-Personality-Questionnaires/16p/gpt/vanilla-result/{mbti_label_content}-vanilla-mbti-gpt3.5-turbo-result.csv'
...
def get_single_model_examing_result():
    ...
    for mbti_item in single_prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'vanilla-result/{mbti_label_content}-vanilla-mbti-gpt3.5-turbo-output.txt'
        result_file_name = f'vanilla-result/{mbti_label_content}-vanilla-mbti-gpt3.5-turbo-result.csv'
