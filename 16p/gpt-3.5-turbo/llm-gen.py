...
def get_response_answer(question, gen_prompt):
...
def get_model_examing_result():
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'llm-gen-result/{mbti_label_content}-gen-prompt-mbti-gpt3.5-output.txt'
        result_file_name = f'llm-gen-result/{mbti_label_content}-gen-prompt-mbti-gpt3.5-result.csv'
        ...
        with open(output_file_name, 'a', encoding='utf-8') as f, open(result_file_name, 'a',
            ...
            for cycle in range(1, 21):
                ...
                for question_num, question in mbti_questions.items():
                    response = get_response_answer(question = question, gen_prompt = generated_prompt)
                    time.sleep(10)
