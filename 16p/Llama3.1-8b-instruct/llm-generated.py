...
def get_model_examing_result(model_id):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'llm-generated-result/{mbti_label_content}-generated-prompt-induce-mbti-llama3.1-8b-instruct-output.txt'
        result_file_name = f'llm-generated-result/{mbti_label_content}-generated-prompt-induce-mbti-llama3.1-8b-instruct-result.csv'
