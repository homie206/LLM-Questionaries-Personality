...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip50_prompt"]:
        ...
        output_file_name = f'llm-gen-result/{ipip_label_content_str}-combine-bfi44-qwen2.5-72b-instruct-output.txt'
        result_file_name = f'llm-gen-result/{ipip_label_content_str}-combine-bfi44-qwen2.5-72b-instruct-result.csv'
