...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'vanilla-result/{ipip_label_content_str}-vanilla-sd3-llama3.1-8b-instruct-output.txt'
        result_file_name = f'vanilla-result/{ipip_label_content_str}-vanilla-sd3-llama3.1-8b-instruct-result.csv'

        if not os.path.isfile(result_file_name):
            df = pd.DataFrame(columns=['MAC1', 'MAC2', 'MAC3', 'MAC4', 'MAC5', 'MAC6', 'MAC7', 'MAC8','MAC9','NAR1', 'NAR2', 'NAR3', 'NAR4', 'NAR5', 'NAR6', 'NAR7', 'NAR8','NAR9','PSY1', 'PSY2', 'PSY3', 'PSY4', 'PSY5', 'PSY6', 'PSY7', 'PSY8','PSY9'])
