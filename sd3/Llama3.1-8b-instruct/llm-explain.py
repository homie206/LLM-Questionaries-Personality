...
prompt_template = {
    "ipip_prompt": [
        {'prompt': 'Please use a paragraph to describe a human who is low on machiavellianism, low on narcissism, low on psychopathy.',
        'label': "['M-Low', 'N-Low', 'P-Low']"},
        {'prompt': 'Please use a paragraph to describe a human who is low on machiavellianism, low on narcissism, high on psychopathy.',
        'label': "['M-Low', 'N-Low', 'P-High']"},
        {'prompt': 'Please use a paragraph to describe a human who is low on machiavellianism, high on narcissism, low on psychopathy.',
        'label': "['M-Low', 'N-High', 'P-Low']"},
        {'prompt': 'Please use a paragraph to describe a human who is low on machiavellianism, high on narcissism, high on psychopathy.',
        'label': "['M-Low', 'N-High', 'P-High']"},
        {'prompt': 'Please use a paragraph to describe a human who is high on machiavellianism, low on narcissism, low on psychopathy.',
        'label': "['M-High', 'N-Low', 'P-Low']"},
        {'prompt': 'Please use a paragraph to describe a human who is high on machiavellianism, low on narcissism, high on psychopathy.',
        'label': "['M-High', 'N-Low', 'P-High']"},
        {'prompt': 'Please use a paragraph to describe a human who is high on machiavellianism, high on narcissism, low on psychopathy.',
        'label': "['M-High', 'N-High', 'P-Low']"},
        {'prompt': 'Please use a paragraph to describe a human who is high on machiavellianism, high on narcissism, high on psychopathy.',
...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'llm-explain/{ipip_label_content_str}-generated-prompt-llama3.1-8b-instruct-output.txt'
        result_file_name = f'llm-explain/{ipip_label_content_str}-generated-prompt-llama3.1-8b-instruct-result.csv'
