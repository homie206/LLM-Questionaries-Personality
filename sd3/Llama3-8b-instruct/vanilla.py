...
if __name__ == '__main__':
    ...
    for ipip_item in prompt_template["ipip_prompt"]:
        ...
        output_file_name = f'vanilla-result/{ipip_label_content_str}-vanilla-sd3-llama3-8b-instruct-output.txt'
        result_file_name = f'vanilla-result/{ipip_label_content_str}-vanilla-sd3-llama3-8b-instruct-result.csv'
